...
PURGED_PATHS='^(ios/|telemetry-worker/|\.github/|scripts/(remote|phone-server)/|scripts/[^/]*\.ps1$|crates/jcode-(telemetry-core|tui-permissions|gateway-types)/|crates/jcode-base/src/(gateway|sponsors)|crates/jcode-app-core/src/tool/discover|crates/jcode-setup-hints/src/windows_(setup|hotkeys)\.rs|crates/jcode-transport/src/windows\.rs|crates/jcode-app-core/src/tool/selfdev/|src/cli/selfdev\.rs|src/cli/telemetry\.rs|crates/jcode-provider-grok-build-runtime/|crates/jcode-base/src/auth/grok_build\.rs|crates/jcode-setup-hints/src/(launch_hotkeys|linux_env|linux_niri|cli_launch_hints)\.rs|crates/jcode-app-core/src/tool/debug_socket\.rs|crates/jcode-base/src/browser(_tests)?\.rs|crates/jcode-app-core/src/tool/browser(_tests)?\.rs|crates/jcode-provider-openai-runtime/src/chatgpt_web\.rs|crates/jcode-base/src/gmail\.rs|crates/jcode-base/src/auth/google\.rs|crates/jcode-notify-email/|crates/jcode-app-core/src/tool/computer/|crates/jcode-app-core/src/tool/jcode_docs\.rs|crates/jcode-app-core/build\.rs|crates/jcode-app-core/src/tool/gmail\.rs|crates/jcode-(desktop2|math|provider-bedrock)/|scripts/(check_desktop2_reload\.py|desktop2_[a-z_]+\.sh)$|TELEMETRY\.md|docs/(SAFETY_SYSTEM|IOS_APP|WINDOWS|DESKTOP[A-Z_0-9]*|AWS_BEDROCK_PROVIDER|BROWSER_PROVIDER_PROTOCOL|GMAIL_COMPOSIO_BACKEND|ONBOARDING_STATE_GRAPH)\.md|crates/jcode-tui/src/tui/(app/onboarding_|ui_onboarding)|crates/jcode-tui/src/tui/ui_tests/onboarding\.rs$|crates/jcode-import-core/src/repo_ranking\.rs$|scripts/capture_onboarding\.sh$)'

# Identifiers that must never enter a file we keep.
PURGED_IDENT='crate::telemetry::|jcode_telemetry_core|crate::gateway::|jcode_gateway_types|jcode_tui_permissions|crate::sponsors|DiscoverToolsTool|RequestPermissionTool|"integration_tools"|"request_permission"|Command::(Pair|Permissions)|handle_telemetry_command|SummaryPill::(Subscription|Telemetry)|TelemetryChoice|TelemetryLevel|record_[a-z_]+\(|windows_setup::|windows_hotkeys::|listen_windows_hotkey|handle_support_command|handle_feedback_command|tool::selfdev|SelfDevTool|client_selfdev_requested|CLIENT_SELFDEV_ENV|SelfDevBuild(Command|Target)|spawn_selfdev_in_new_terminal|register_dev_tools|set_canary|prefer_selfdev_binary|no_selfdev|self_dev:|run_setup_hotkey|run_macos_hotkey_listener|LaunchHotkeysConfig|LaunchHotkeyEntry|bake_launch_hotkeys_once|MacHotkeyAction|spawn_hotkey|jcode_provider_grok_build_runtime|GrokBuildProvider|GROK_BUILD_|XAI_PROFILE|XAI_LOGIN_PROVIDER|ProviderChoice::(Xai|GrokBuild)|jcode_desktop2|jcode_math|jcode_provider_bedrock|provider::bedrock|BedrockProvider|AWS_BEARER_TOKEN_BEDROCK|JCODE_BEDROCK_|SelfDevBuildTarget::Desktop2|Onboarding(Phase|Flow|Action|WelcomeKind)|onboarding_(flow|graph|sim|repair|preview|welcome)|ui_onboarding|is_new_user_install|prefer_strongest|repo_ranking'

...
PURGED_PATHS='^(ios/|telemetry-worker/|\.github/|scripts/(remote|phone-server)/|crates/jcode-(telemetry-core|tui-permissions|gateway-types)/|crates/jcode-base/src/(gateway|sponsors)|crates/jcode-app-core/src/tool/discover|src/cli/telemetry\.rs|TELEMETRY\.md|docs/(SAFETY_SYSTEM|IOS_APP)\.md)'

...
///
/// The three tools listed below were already non-strict before that change, for
...
/// detector: a fourth name appearing means a stricter rule went too far, and a
...
async fn only_the_known_open_world_tools_are_ineligible_for_openai_strict_mode() {
    ...
    const KNOWN_OPEN_WORLD_TOOLS: &[&str] = &["batch", "initiative", "swarm"];

pub use jcode_tui_mermaid::{
    ...
    materialize_inline_image, materialize_inline_image_by_id, normalize_aspect_ratio,
    parse_image_placeholder, parse_inline_image_placeholder, preferred_aspect_ratio_bucket,
    prewarm_inline_fit_state, protocol_type, rediscover_external_image, rediscover_inline_image,
    register_active_diagram, register_external_image, register_inline_image, render_image_widget,
    render_image_widget_fit, render_image_widget_fit_stable, render_image_widget_scale,
    ...
    result_to_content, result_to_lines, set_image_placeholder_mode, set_log_hooks,
    set_memory_snapshot_hook, set_render_completed_hook, set_streaming_preview_diagram,
    snapshot_active_diagrams, take_terminal_image_cleanup_payload, text_image_fallback_note_line,

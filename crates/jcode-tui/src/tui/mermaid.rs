pub use jcode_tui_mermaid::{
    ...
    inline_transcript_aspect_goal_with_font, invalidate_render_state, is_image_placeholder_mode,
    is_mermaid_lang, materialize_inline_image, materialize_inline_image_by_id,
    ...
    reset_debug_stats, restore_active_diagrams, result_to_content, result_to_lines,
    set_image_placeholder_mode, set_log_hooks, set_memory_snapshot_hook, set_render_completed_hook,
    set_streaming_preview_diagram, snapshot_active_diagrams, take_terminal_image_cleanup_payload,
    ...
    with_image_protocol_override, with_preferred_aspect_ratio,
};

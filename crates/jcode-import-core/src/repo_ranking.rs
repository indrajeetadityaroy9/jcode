...
//!
//! The consumer is onboarding: after auto-import we want to suggest the project
//! directory the user is most likely to reopen (the "recent project" action).
...
/// Tunables for [`rank_repositories`]. Defaults are chosen for the onboarding
/// suggestion use case (a handful of top repos, recency-biased).
#[derive(Debug, Clone)]
